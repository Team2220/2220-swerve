...
public class Arc {
    ...
    public Point getPointOnArc(double t) {
        ...
        double x =
            (start.x * t * t) - (2 * start.x * t) + start.x
            - (2 * mid.x * t * t) + (2 * mid.x * t)
            + (end.x * t * t);
        
        double y =
            (start.y * t * t) - (2 * start.y * t) + start.y
            - (2 * mid.y * t * t) + (2 * mid.y * t)
            + (end.y * t * t);
    ...
    public double getVelocityAtPoint(double t) {
        ...
        double x = 
            (2 * start.x * t) - (2 * start.x)
            - (4 * mid.x * t) + (2 * mid.x)
            + (2 * end.x * t);

        double y = 
            (2 * start.y * t) - (2 * start.y)
            - (4 * mid.y * t) + (2 * mid.y)
            + (2 * end.y * t);
    ...
    public static Arc arcLines(double radius, Line from, Line to) {
        ...
        if (Math.abs(from.getLineAngle() - to.getLineAngle()) > 180)
            radius = -radius;
