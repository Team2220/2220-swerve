...
public class SequentialMove extends CommandBase {
  ...
  public SequentialMove(
      Swerve swerve, double radius, double endMovTol, double endRotTol, Position... positions) {
  ...
  public void initialize() {
    ...
    Constraints constraints =
        new Constraints(GeneralConfig.DT_MAX_VEL.getValue(), GeneralConfig.DT_MAX_ACCEL.getValue());
  }
}
