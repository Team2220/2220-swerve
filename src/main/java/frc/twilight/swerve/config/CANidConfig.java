...
public class CANidConfig {
  ...
  // Drive motor
  public static final int DT_FR_DM = 18;
  // Steer motor
  public static final int DT_FR_SM = 17;
  ...
  // Drive motor
  public static final int DT_BL_DM = 16;
  // Steer motor
  public static final int DT_BL_SM = 15;
  ...
  // Drive motor
  public static final int DT_BR_DM = 14;
  // Steer motor
  public static final int DT_BR_SM = 13;
