...
public class VectorFactory {
  ...
  public static DriveVector driveVectorFromWheelVectors(
    ...
    double fwd =
        (FR.getVelocity() * Math.sin(FR.getAngle() * Math.PI / 180)
                + FL.getVelocity() * Math.sin(FL.getAngle() * Math.PI / 180)
                + BR.getVelocity() * Math.sin(BR.getAngle() * Math.PI / 180)
                + BL.getVelocity() * Math.sin(BL.getAngle() * Math.PI / 180))
            / 4;

    double str =
        (FR.getVelocity() * Math.cos(FR.getAngle() * Math.PI / 180)
                + FL.getVelocity() * Math.cos(FL.getAngle() * Math.PI / 180)
                + BR.getVelocity() * Math.cos(BR.getAngle() * Math.PI / 180)
                + BL.getVelocity() * Math.cos(BL.getAngle() * Math.PI / 180))
            / 4;
